function ply_data = tri_mesh_to_ply ( node_xyz, color_xyz, triangle_node )
...
%
  ...
  % Store the color
  ply_data.vertex.red = color_xyz(1,1:node_num);
  ply_data.vertex.green = color_xyz(2,1:node_num);
  ply_data.vertex.blue = color_xyz(3,1:node_num);
